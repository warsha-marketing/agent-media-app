...
- **Seedance 2.0 Mini on ModelArk** gave the most real-looking result. That used the original app's realism wording (raw iPhone look, flat everyday light, sharp background, matte skin with pores) and an In-use Reference of the product.
...
- **Cinematic lighting** (golden hour, warm lamps, shallow depth of field) makes Seedance skin look waxy. Person-shot prompts carry the realism Guardrail.
